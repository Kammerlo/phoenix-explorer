import { Amt, BlockDto, Epoch, PoolRegistration, PoolRetirement, TransactionDetails, TxUtxo } from "../types";
...
export async function mapPoolRegistrationsToRegistrations(data: PoolRegistration[]): Promise<Registration[]> {
...
export function mapPoolRetirementsToRegistrations(data: PoolRetirement[]): Registration[] {
